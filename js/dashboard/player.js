...
import { renderArtistPanel } from './discover.js';
import { highlightActiveSong } from './songlist.js';

const heroEl = document.getElementById('now-playing-hero'),
...
// El hero ("Top del momento") es un destacado fijo, independiente de qué se
// esté reproduciendo — no lo toca loadMusic(). Se llama una vez al arrancar
// el dashboard (y de nuevo si llegan recomendaciones que cambian el primer
// puesto de "Inicio", ver main.js/discover.js). Clickearlo reproduce esa
// canción (ver el listener de heroEl más abajo).
export function setHero(song) {
    heroSong = song;
